...
TEST_CASE("iblt_list (threshold=2^18, n=2^19, mult_fac=1.5)", "[list][n=2^19]") {
    BENCHMARK_ADVANCED("n=2^19 online phase")(Catch::Benchmark::Chronometer meter) {
        size_t threshold = 1 << 19; // 1 million
        size_t num_elements_to_insert = 1 << 19; // n = 1 million
...
TEST_CASE("iblt_list (threshold=2^21, n=2^21, mult_fac=1.5)", "[list][n=2^21]") {
...
TEST_CASE("iblt::cache_sensitive_list (threshold=2^21, n=2^21, mult_fac=1.5)", "[cached_list][n=2^21]") {
    BENCHMARK_ADVANCED("iblt::cache_sensitive_list t=2^21 n=2^21")(Catch::Benchmark::Chronometer meter) {
        size_t threshold = 1 << 21; // 2 million
        size_t num_elements_to_insert = 1 << 21; // n = 2 million
...
TEST_CASE("iblt::queued_iblt_list (threshold=2^21, n=2^21, mult_fac=1.5)", "[queued_list][n=2^21]") {
